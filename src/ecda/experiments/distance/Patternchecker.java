...
public class Patternchecker
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		String outputFile = "./files/distanceOutputTotal.csv";

		FileWriter writer = new FileWriter(outputFile, false);
		CSVUtils.writeLine(writer, Arrays.asList("folder", "column", "versions", "rows", "simpleJaccard", "completeJaccard", "average", "dataType"));
	...
	private static List<String> getColumn(int x, Table table, Map<Key, Cell> map, String file)
	{
		...
		return Arrays.asList(file, x + "", versions + "", rows + "", simpleJaccard + "", completeJaccard + "", size + "", type + "");
	}
